                                        ...
                                        <ul class="sub-menu">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <li><a href="{{ route('pvt') }}"> Private Limited Company</a></li>
                                                    <li><a href="{{ route('limited') }}">Limited Company Registration</a></li>
                                                </div>
                                                <div class="col-lg-6">
                                                    <li><a href="{{ route('nidhi') }}">Nidhi Company</a></li>
                                                    <li><a href="{{ route('section8') }}">Section 8 Company</a></li>
                                                    <li><a href="{{ route('ngo') }}">NGO Registration</a></li>
                                                    <li><a href="{{ route('ngo-trust') }}">Trust Registration</a></li>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="text-white mb-30">Want to see our predefined quotation? <a href="{{ asset('assets/img/Quotetion.pdf') }}" class="text-white text-decoration-underline quote-link-inline" target="_blank" rel="noopener noreferrer">Click here <span class="quote-link-arrow" aria-hidden="true">&rarr;</span></a>.</p>
