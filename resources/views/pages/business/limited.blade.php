...
@section('title', 'Limited Company Registration in Kolkata | Pvt Ltd Company Formation | 360 Business and Services')
@section('meta_description', 'Register your Limited Company in Kolkata with 360 Business and Services. Expert assistance for Pvt Ltd company formation, documentation, and legal compliance. Limited liability protection, easy fundraising, and corporate credibility. Starting from ₹10,999. Get your company incorporated quickly and efficiently.')
@section('keywords', 'limited company registration Kolkata, pvt ltd company formation, company incorporation Kolkata, limited company registration process, pvt ltd registration cost, company registration services, business incorporation Kolkata, limited liability company, startup company registration, ROC filing Kolkata, corporate registration services, company formation, company registration consultants Kolkata')
@section('canonical_url', url('/pvt'))

@section('og_title', 'Limited Company Registration in Kolkata | Pvt Ltd Formation | 360 Business and Services')
...
@section('og_image_alt', 'Limited Company Registration Services in Kolkata - 360 Business and Services')

@section('twitter_title', 'Pvt Ltd Company Registration in Kolkata | 360 Business and Services')
@section('twitter_description', 'Expert Limited Company registration in Kolkata. Professional assistance for company formation & compliance. Limited liability protection from ₹10,999.')
...
<script type="application/ld+json">
    {
        ...
        "@type": "Service",
        "name": "Limited Company Registration",
        "description": "Professional Limited Company registration services in Kolkata with expert assistance for company formation, documentation and legal compliance.",
        "provider": {
            "@type": "Organization",
        ...
        "offers": {
            ...
            "price": "10999",
            "priceCurrency": "INR",
            "description": "Starting price for Limited Company registration including basic documentation and filing"
        },
        "category": "Business Formation",
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Limited Company Registration Services",
            "itemListElement": [{
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                ...
                <div class="col-lg-7 order-lg-0 order-0">
                    <div class="services-details-wrap">
                        <div class="services-details-content">
                            <h2 class="title">Limited Company</h2>
                            <p>Incorporate your business with credibility, growth potential, and limited liability.</p>
                            <p>A Limited Company (Ltd) is one of the most trusted and widely adopted business structures in India. Registered under the Companies Act, 2013, it offers a perfect blend of limited liability, separate legal existence, and corporate credibility. It is the preferred structure for startups, SMEs, and high-growth businesses aiming to attract investors and scale rapidly.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12 my-auto">
                            <ul class="list-wrap1">
                                ...
                                <li>Office Images</li>
                                <li class="pt-4"><strong>** Min. Three Directors ( At least one Director must be Indian Resident) </strong></li>
                                <li><strong>** Min 7 Share Holders. </strong></li>
                                <li><strong>** Min ₹5 Lakhs Paid up capital </strong></li>
                            </ul>
                        </div>
                    </div>
                </div>
