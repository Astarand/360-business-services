...
@section('title', 'Hindu Undivided Family ( HUF) Deed - 360 Business and Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>A Hindu Undivided Family (HUF) Deed is a legal document that establishes the formation and operation of a Hindu Undivided Family under the Hindu Succession Act. It typically outlines the roles, rights, and responsibilities of family members within the HUF, including the management of assets, income, and expenses. The deed may include details such as the names of family members, their shares in the HUF property, and provisions for succession and inheritance. It serves as an essential document for the governance and succession of an HUF.</p>
